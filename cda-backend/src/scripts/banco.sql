...
-- PLATAFORMA DE GESTÃO DO CICLO DE DESEMPENHO – CDA 2026
-- PostgreSQL / Supabase Compatible
-- Versão: 2.3 FINAL (VALIDADA)
-- ==========================================================
...
CREATE TABLE IF NOT EXISTS public.colaborador (
    ...
    created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    CONSTRAINT fk_colaborador_usuario FOREIGN KEY (usuario_id)
        REFERENCES public.usuario(id),
    CONSTRAINT fk_colaborador_cargo FOREIGN KEY (cargo_id)
        REFERENCES public.cargo(id),
    CONSTRAINT fk_colaborador_gestor FOREIGN KEY (gestor_id)
...
CREATE TABLE IF NOT EXISTS public.ciclo_desempenho (
    ...
    CONSTRAINT fk_ciclo_criado_por FOREIGN KEY (criado_por)
        REFERENCES public.usuario(id),
    CONSTRAINT chk_periodo_ciclo CHECK (data_fim >= data_inicio)
);
...
CREATE TABLE IF NOT EXISTS public.ciclo_colaborador (
    ...
    created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    CONSTRAINT fk_cc_ciclo FOREIGN KEY (ciclo_id)
        REFERENCES public.ciclo_desempenho(id),
    CONSTRAINT fk_cc_colaborador FOREIGN KEY (colaborador_id)
        REFERENCES public.colaborador(id),
    CONSTRAINT uq_ciclo_colaborador UNIQUE (ciclo_id, colaborador_id),
    CONSTRAINT chk_status_experiencia
        CHECK (status_experiencia IN ('EM_ANDAMENTO', 'CONCLUIDO'))
);
...
CREATE TABLE IF NOT EXISTS public.competencia (
    ...
    created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    CONSTRAINT chk_categoria_competencia
...
CREATE TABLE IF NOT EXISTS public.avaliacao (
    ...
    created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    CONSTRAINT fk_avaliacao_cc FOREIGN KEY (ciclo_colaborador_id)
        REFERENCES public.ciclo_colaborador(id),
    CONSTRAINT fk_avaliacao_avaliador FOREIGN KEY (avaliador_id)
        REFERENCES public.colaborador(id),
    CONSTRAINT uq_avaliacao UNIQUE (ciclo_colaborador_id, avaliador_id, tipo),
...
CREATE TABLE IF NOT EXISTS public.pontuacao (
    ...
    created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    CONSTRAINT fk_pontuacao_avaliacao FOREIGN KEY (avaliacao_id)
        REFERENCES public.avaliacao(id),
    CONSTRAINT fk_pontuacao_competencia FOREIGN KEY (competencia_id)
        REFERENCES public.competencia(id),
    CONSTRAINT fk_pontuacao_meta FOREIGN KEY (meta_id)
        REFERENCES public.meta(id),
    CONSTRAINT chk_item_avaliado CHECK (
        (competencia_id IS NOT NULL AND meta_id IS NULL)
        OR
        (competencia_id IS NULL AND meta_id IS NOT NULL)
    ),
    CONSTRAINT uq_pontuacao_competencia UNIQUE (avaliacao_id, competencia_id),
    CONSTRAINT uq_pontuacao_meta UNIQUE (avaliacao_id, meta_id)
);
...
CREATE TABLE IF NOT EXISTS public.nine_box (
    ...
    created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    CONSTRAINT fk_ninebox_cc FOREIGN KEY (ciclo_colaborador_id)
        REFERENCES public.ciclo_colaborador(id)
);
...
CREATE TABLE IF NOT EXISTS public.colaborador_trilha (
    ...
    created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    CONSTRAINT fk_trilha_plano FOREIGN KEY (plano_id)
        REFERENCES public.plano_carreira(id),
    CONSTRAINT fk_trilha_colaborador FOREIGN KEY (colaborador_id)
        REFERENCES public.colaborador(id),
    CONSTRAINT uq_trilha UNIQUE (plano_id, colaborador_id),
    CONSTRAINT chk_status_trilha
        CHECK (status IN ('LIBERADO', 'EM_ANDAMENTO', 'CONCLUIDO'))
);

-- ==========================================================
-- 14. FUNÇÃO + TRIGGERS DE AUDITORIA
-- ==========================================================
...
-- ==========================================================
CREATE INDEX idx_ciclo_colaborador_ciclo ON public.ciclo_colaborador (ciclo_id);
CREATE INDEX idx_avaliacao_cc ON public.avaliacao (ciclo_colaborador_id);
CREATE INDEX idx_pontuacao_avaliacao ON public.pontuacao (avaliacao_id);
